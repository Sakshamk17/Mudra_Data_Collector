...
// import { WebcamFeed } from "./WebcamFeed"; // reuse your working feed
...
// const MUDRAS = ["Pataka", "Tripataka", "Ardhapataka"];
...
//   // This function will be called from WebcamFeed for each frame
//   const handleFrame = (results: any) => {
...
//     a.href = url;
//     a.download = "mudra_dataset.json";
//     a.click();
//   };

//   return (
//     <div className="flex flex-col gap-4 items-center p-4">
//       <h1 className="text-xl font-bold text-white">Dataset Collector</h1>
...
//         Collected frames: {collectedData.length}
//       </p>
//     </div>
//   );
// }
